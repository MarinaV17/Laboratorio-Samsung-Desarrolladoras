...
function goBackToRegister(){
    window.open(window.location.href.replace('consulta.html', 'index.html'))
}

function clickSeeUsers(){
    getUsersData()
    document.getElementById('tableContainer').hidden = false
    document.getElementById('seeUsers').disabled=true
}
